...
import { proveedorControladora } from '../../../controladora/proveedor'
...
router.post("/newProvider", proveedorControladora.newProveedor);

router.get("/getProvider", proveedorControladora.getTodosProveedores);
